 ...
 */
function azb_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter AZB Theme default saturation level.
	 *
	 * @since AZB Theme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'azb_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.azb-front-page) .entry-title,
...
.colors-custom .azb-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.azb-front-page .panel-content .recent-posts article,
...
.colors-custom.azb-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters AZB Theme custom colors CSS.
	 *
	 * @since AZB Theme 1.0
	 *
	 ...
	 */
	return apply_filters( 'azb_custom_colors_css', $css, $hue, $saturation );
}
